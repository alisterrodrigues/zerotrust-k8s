...
var _ = BeforeSuite(func() {
	...
	var err error
	// clientgoscheme.Scheme already includes core, RBAC, networking; add our CRD types for the test client.
	err = zerotrustv1alpha1.AddToScheme(clientgoscheme.Scheme)
